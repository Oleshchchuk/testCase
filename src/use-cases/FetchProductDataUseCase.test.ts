...
import {FetchProductDataUseCase} from "./FetchProductDataUseCase";
...
describe('FetchProductDataUseCase', () => {
    it('should fetch product data, classify, sort linked products, and update redux state', async () => {
        ...
        const useCase = new FetchProductDataUseCase(mockProductService, mockReduxService);
        const productId = '1';

        // Создаем моки для продуктов и категорий
        ...
        // Проверка логики классификации и сортировки связанных продуктов
